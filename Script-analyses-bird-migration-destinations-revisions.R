...
habitat.raster <- raster("/Users/mariussomveille/Dropbox/Other analyses/Plumage/Submission/JEB/Plumage_revisions/LC_hd_global_2010.tif", header=T)
recl<-matrix(c(0:16, c(NA,1,1,1,1,1,0.5,0.5,0.5,0,0,NA,0,0,0.5,0,0)),ncol=2)
landcover <- reclassify(habitat.raster, rcl=recl)

habitatCoverage <- vector()
for(i in 1:length(hexgrid)){
	habitatCoverage[i] <- extract(landcover, hexgrid[i,], fun = mean, na.rm=T)
}
...
envData2 <- envData[-which((envData$Tmean_NW==0 & envData$Tmean_NS==0) | is.na(envData$habitatCoverage) == T),]
...
PresAbs_BR_NH <- PresAbs_BR_NH[-which((envData$Tmean_NW==0 & envData$Tmean_NS==0) | is.na(envData$habitatCoverage) == T),]
PresAbs_NB_NH <- PresAbs_NB_NH[-which((envData$Tmean_NW==0 & envData$Tmean_NS==0) | is.na(envData$habitatCoverage) == T),]
PresAbs_BR_SH <- PresAbs_BR_SH[-which((envData$Tmean_NW==0 & envData$Tmean_NS==0) | is.na(envData$habitatCoverage) == T),]
PresAbs_NB_SH <- PresAbs_NB_SH[-which((envData$Tmean_NW==0 & envData$Tmean_NS==0) | is.na(envData$habitatCoverage) == T),]
PresAbs_residents <- PresAbs_residents[-which((envData$Tmean_NW==0 & envData$Tmean_NS==0) | is.na(envData$habitatCoverage) == T),]
...
jpeg("Fig3_hab.jpg", width=350, height=500, quality=100)
par(mfrow=c(4,2), mar=c(2.9,3,1.5,3), mgp=c(1.5,0.5,0))
# Relationship between geographical distance and thermal distance
plot(sqrt(geo.distances.obs), thermal.distances.obs, xlim=c(0,120), ylim=c(0,28), xlab="Geographical distance (square-root)", ylab="Thermal distance", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1)
axis(side=2)
axis(side=1)
...
mtext("A", cex=1.5, side=3, line=0, at=-20)
...
plot(resource.scarcity.obs, thermal.distances.obs, ylim=c(0,28), xlab="Resource scarcity", ylab="Thermal distance", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1)
axis(side=2)
axis(side=1)
...
mtext("B", cex=1.5, side=3, line=0, at=-80)
...
plot(sqrt(geo.distances.obs), habitat.distances.obs, xlim=c(0,120), xlab="Geographical distance (square-root)", ylab="Habitat distance", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1)
axis(side=2)
axis(side=1)
mod = lm(habitat.distances.obs ~ sqrt(geo.distances.obs) + I(sqrt(geo.distances.obs)^2))
lines(sort(sqrt(geo.distances.obs)), fitted(mod)[order(sqrt(geo.distances.obs))], type="l", col="red")
mtext("C", cex=1.5, side=3, line=0, at=-20)
mtext(bquote(R^2 == .(round(summary(mod)$r.squared,2))), cex=1, side=3, line=-1, at=20)
# Relationship between resource scarcity and habitat distance
plot(resource.scarcity.obs, habitat.distances.obs, xlab="Resource scarcity", ylab="Habitat distance", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1)
axis(side=2)
axis(side=1)
mod = lm(habitat.distances.obs ~ resource.scarcity.obs + I(resource.scarcity.obs^2))
lines(sort(resource.scarcity.obs), fitted(mod)[order(resource.scarcity.obs)], type="l", col="red")
mtext("D", cex=1.5, side=3, line=0, at=-80)
mtext(bquote(R^2 == .(round(summary(mod)$r.squared,2))), cex=1, side=3, line=-1, at=-45)
# Relationship between geographical distance and resource scarcity
plot(sqrt(geo.distances.obs), resource.scarcity.obs, xlim=c(0,120), xlab="Geographical distance (square-root)", ylab="Resource scarcity", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1)
axis(side=2)
axis(side=1)
mod = lm(resource.scarcity.obs ~ sqrt(geo.distances.obs) + I(sqrt(geo.distances.obs)^2))
lines(sort(sqrt(geo.distances.obs)), fitted(mod)[order(sqrt(geo.distances.obs))], type="l", col="red")
mtext("E", cex=1.5, side=3, line=0, at=-20)
...
plot(habitat.distances.obs, thermal.distances.obs, xlab="Habitat distance", ylab="Thermal distance", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1)
axis(side=2)
axis(side=1)
...
mtext("F", cex=1.5, side=3, line=0, at=-0.1)
...
plot(sqrt(geo.distances.obs), resource.scarcity.obs, xlim=c(0,120), xlab="Geographical distance (square-root)", ylab="Resource scarcity", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1, col="yellow")
axis(side=2)
points(sqrt(geo.distances.obs)[which(thermal.distances.obs < quantile(thermal.distances.obs)[4])], resource.scarcity.obs[which(thermal.distances.obs < quantile(thermal.distances.obs)[4])], col="orange", cex=0.8, cex.lab=1.1, pch=20)
points(sqrt(geo.distances.obs)[which(thermal.distances.obs < quantile(thermal.distances.obs)[3])], resource.scarcity.obs[which(thermal.distances.obs < quantile(thermal.distances.obs)[3])], col="red", cex=0.8, cex.lab=1.1, pch=20)
points(sqrt(geo.distances.obs)[which(thermal.distances.obs < quantile(thermal.distances.obs)[2])], resource.scarcity.obs[which(thermal.distances.obs < quantile(thermal.distances.obs)[2])], col="brown4", cex=0.8, cex.lab=1.1, pch=20)
mtext("G", cex=1.5, side=3, line=0, at=-20)
...
plot(sqrt(geo.distances.obs), resource.scarcity.obs, xlim=c(0,120), xlab="Geographical distance (square-root)", ylab="Resource scarcity", main="", xaxt="n", axes=F, pch=20, cex=0.8, cex.lab=1.1, col="yellow")
axis(side=2)
points(sqrt(geo.distances.obs)[which(habitat.distances.obs < quantile(habitat.distances.obs)[4])], resource.scarcity.obs[which(habitat.distances.obs < quantile(habitat.distances.obs)[4])], col="orange", cex=0.8, cex.lab=1.1, pch=20)
points(sqrt(geo.distances.obs)[which(habitat.distances.obs < quantile(habitat.distances.obs)[3])], resource.scarcity.obs[which(habitat.distances.obs < quantile(habitat.distances.obs)[3])], col="red", cex=0.8, cex.lab=1.1, pch=20)
points(sqrt(geo.distances.obs)[which(habitat.distances.obs < quantile(habitat.distances.obs)[2])], resource.scarcity.obs[which(habitat.distances.obs < quantile(habitat.distances.obs)[2])], col="brown4", cex=0.8, cex.lab=1.1, pch=20)
mtext("H", cex=1.5, side=3, line=0, at=-20)
mtext("Number of species", side=4, line=1.4, cex=0.7,las=0)
...
for(i in 1:length(breeding.thermal.optimumNH_WH)){
	breeding.thermal.optimum.simulated_NH_WH <- lapply(simulated.ranges_BR_NH_WH[[i]], function(x) mean(TempNS_WH[x]))
	thermal.distances.simulatedBR_NH_WH <- abs(unlist(breeding.thermal.optimum.simulated_NH_WH) - nonbreeding.thermal.optimumNH_WH[i])
	nonbreeding.thermal.optimum.simulated_NH_WH <- lapply(simulated.ranges_NB_NH_WH[[i]], function(x) mean(TempNW_WH[x]))
	thermal.distances.simulatedNB_NH_WH <- abs(breeding.thermal.optimumNH_WH[i] - unlist(nonbreeding.thermal.optimum.simulated_NH_WH))
...
for(i in 1:length(breeding.thermal.optimumSH_WH)){
	breeding.thermal.optimum.simulated_SH_WH <- lapply(simulated.ranges_BR_SH_WH[[i]], function(x) mean(TempNW_WH[x]))
	thermal.distances.simulatedBR_SH_WH <- abs(unlist(breeding.thermal.optimum.simulated_SH_WH) - nonbreeding.thermal.optimumNH_WH[i])
	nonbreeding.thermal.optimum.simulated_SH_WH <- lapply(simulated.ranges_NB_SH_WH[[i]], function(x) mean(TempNS_WH[x]))
	thermal.distances.simulatedNB_SH_WH <- abs(breeding.thermal.optimumSH_WH[i] - unlist(nonbreeding.thermal.optimum.simulated_SH_WH))
...
for(i in 1:length(breeding.thermal.optimumNH_EH)){
	breeding.thermal.optimum.simulated_NH_EH <- lapply(simulated.ranges_BR_NH_EH[[i]], function(x) mean(TempNS_EH[x]))
	thermal.distances.simulatedBR_NH_EH <- abs(unlist(breeding.thermal.optimum.simulated_NH_EH) - nonbreeding.thermal.optimumNH_EH[i])
	nonbreeding.thermal.optimum.simulated_NH_EH <- lapply(simulated.ranges_NB_NH_EH[[i]], function(x) mean(TempNW_EH[x]))
	thermal.distances.simulatedNB_NH_EH <- abs(breeding.thermal.optimumNH_EH[i] - unlist(nonbreeding.thermal.optimum.simulated_NH_EH))
...
for(i in 1:length(breeding.thermal.optimumSH_EH)){
	breeding.thermal.optimum.simulated_SH_EH <- lapply(simulated.ranges_BR_SH_EH[[i]], function(x) mean(TempNW_EH[x]))
	thermal.distances.simulatedBR_SH_EH <- abs(unlist(breeding.thermal.optimum.simulated_SH_EH) - nonbreeding.thermal.optimumNH_EH[i])
	nonbreeding.thermal.optimum.simulated_SH_EH <- lapply(simulated.ranges_NB_SH_EH[[i]], function(x) mean(TempNS_EH[x]))
	thermal.distances.simulatedNB_SH_EH <- abs(breeding.thermal.optimumSH_EH[i] - unlist(nonbreeding.thermal.optimum.simulated_SH_EH))
...
for(i in 1:length(breeding.habitatSH_EH)){
	...
	habitat.distances.simulatedBR_SH_EH <- abs(unlist(breeding.habitat.simulated_SH_EH) - nonbreeding.thermal.optimumNH_EH[i])
